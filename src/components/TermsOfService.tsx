...
interface ModalProps {
  open: boolean;
  onClose: () => void;
  slug?: string; // defaults to 'terms-of-service'
}

export default function TermsOfServiceModal({ open, onClose, slug = 'terms-of-service' }: ModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative max-w-3xl w-full bg-white rounded-xl shadow-xl overflow-auto max-h-[80vh] p-6">
        <div className="flex items-start justify-between mb-4">
          <h2 className="text-xl font-semibold text-primary">{page?.title?.rendered || 'Terms of Service'}</h2>
